#!/bin/bash
##COPY RIGHT::: HARI DATT PANDEY, DEPARTMENT OF CHEMICAL PHYSICS, UNIVERSITY OF NEVADA RENO.
...
echo "COPY RIGHT::: HARI DATT PANDEY, DEPARTMENT OF CHEMICAL PHYSICS, UNIVERSITY OF NEVADA RENO."
